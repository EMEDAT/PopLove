// components/onboarding/ReligiousBeliefSelection.tsx
...
interface ReligiousBeliefSelectionProps {
...
export default function ReligiousBeliefSelection({ 
  selectedOption, 
  onSelectOption,
  visibleOnProfile = true,
  onToggleVisibility = () => {}
}: ReligiousBeliefSelectionProps) {
