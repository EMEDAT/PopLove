// components/onboarding/DrugUsageSelection.tsx
...
interface DrugUsageSelectionProps {
...
export default function DrugUsageSelection({ 
  selectedOption, 
  onSelectOption,
  visibleOnProfile = true,
  onToggleVisibility = () => {}
}: DrugUsageSelectionProps) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Do you use recreational drugs?</Text>
