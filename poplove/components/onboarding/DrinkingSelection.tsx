// components/onboarding/DrinkingSelection.tsx
...
interface DrinkingSelectionProps {
...
export default function DrinkingSelection({ 
  selectedOption, 
  onSelectOption,
  visibleOnProfile = true,
  onToggleVisibility = () => {}
}: DrinkingSelectionProps) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Do you drink?</Text>
